    ...
    public Payments() {
        ...
        if (!string.IsNullOrWhiteSpace(confirm) && confirm == "Y") {
            ...
            if (!string.IsNullOrWhiteSpace(payment) && payment == "A") {
                ...
                Console.WriteLine("If you would like to pay with another method of payment. [N]");
                ...
                } else if (!string.IsNullOrWhiteSpace(confirmCreditPayment) && confirmCreditPayment == "N") {
                    Console.WriteLine("Would you like to pay with a debit card? [Y] or [N]");
                    string payWithDebit = Console.ReadLine();
                    if (!string.IsNullOrWhiteSpace(payWithDebit) && payWithDebit == "Y") {
                        Console.WriteLine("Enter your debit card number:");
                        string debitPayment = Console.ReadLine();
                        Console.WriteLine("Please confirm payment. Is this correct? [Y] or [N]");
                ...
                //debit card payment
                } else if (!string.IsNullOrWhiteSpace(payment) && payment == "B") {
                    Console.WriteLine("Enter your debit card number:");
                    ...
                    Console.WriteLine("If you would like to pay with another method of payment. [N]");
                        ...
                        //if customer chooses to pay with debit card after choosing credit first
                        if (!string.IsNullOrWhiteSpace(confirmDebitPayment) && confirmDebitPayment == "N") {
                            Console.WriteLine("Would you like to pay with a credit card? [Y]");
                            string payWithDebit = Console.ReadLine();
                            if (!string.IsNullOrWhiteSpace(payWithDebit) && payWithDebit == "Y") {
                                Console.WriteLine("Enter your credit card number:");
                                string debitPayment = Console.ReadLine();
                                ...
                                if (!string.IsNullOrWhiteSpace(confirmDebitPaymentTwo) && confirmDebitPaymentTwo == "Y") {
                                    Console.WriteLine("Thank you for your payment. Your order is being processed. We will notify when your order is ready.");
                                }
                            }
                        }
